...
public class SendMailTest {
    ...
    public void SendMail() {
        ...
        Mail mail = Mail.builder()
                .receiverMail("apfhd0257@naver.com")
...
//        String url = "url?token=1234!";
        ...
        String str2 = """
                                                ...
                                                <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                                                    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                                        <p class="size-17" style="Margin-top: 0;Margin-bottom: 0;font-size: 17px;line-height: 26px;" lang="x-size-17">이 링크는 발급 후 5분 동안만 유효합니다. 링크에 문제가 있거나 다른 문제가 발생하면 언제든지 고객 센터로 연락주시기 바랍니다.</p>
                                                    </div>
                                                </div>
                """.formatted("this.appHost", "this.url");
        String str3 =  """
                                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                                            <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                                                <p class="size-17" style="Margin-top: 20px;Margin-bottom: 20px;font-size: 17px;line-height: 26px;" lang="x-size-17">
                        ...
                        """;
        str1 = str1.formatted("this.subject", "this.body");
        String body = str1 + (url!= null? str2: "") + str3;
        System.out.println(body);
