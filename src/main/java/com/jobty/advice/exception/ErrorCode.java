...
import com.jobty.global.response.BaseCode;
...
public enum ErrorCode implements BaseCode {
    ...
    NotActivatedAccount(6011, "메일 인증이 안된 계정입니다. 메일 인증 완료 후 다시 시도해주세요.", "메일 인증이 안된 계정입니다. 메일 인증 완료 후 다시 시도해주세요."),
    // 토큰 관련
    TokenExpired(6008, "로그인 시간이 초과되었습니다. 다시 로그인해주세요.", "토큰이 만료되었습니다."),
    UnexpectedToken(6009, "올바른 토큰 형식이 아닙니다.", "올바른 토큰 형식이 아닙니다."),
    ...
    // 파일
    FailedSaveFile(8001, "파일 저장에 실패했습니다.", "파일 저장에 실패하였습니다."),
    FailedDownloadFile(8002, "파일 다운로드에 실패했습니다.", "파일 가져오기에 실패하였습니다."),
    FailedDeleteFile(8003, "파일 삭제에 실패했습니다.", "파일 삭제에 실패하였습니다."),
    FileNotHavePermission(8004, "파일 삭제에 실패했습니다. 파일에 권한이 없습니다.", "파일 삭제에 실패했습니다. 파일에 권한이 없습니다."),
    // 메뉴
    ...
    NoMenuData(8054, "메뉴 데이터가 없습니다.", "메뉴 데이터가 없습니다."),
